...
<div class="card"style="width:90%; margin: auto;">
  ...
  padding: 10px;" >
        ...
        <input type="hidden" name="notify_url" value="https://gestioncapteursincendie.herokuapp.com/redirect.php?id={{$facture->id}}"> <!-- Please add IPN URL You can use this service to automate back-office and administrative functions, including fulfilling orders, tracking customers, and providing status and other information related to transactions. -->
        <input type='hidden' name='cancel_return' value='' /> <!-- Take customers to this URL when they cancel their checkout -->
        <input type='hidden' name='return' value='https://gestioncapteursincendie.herokupapp.com/redirect.php?id={{$facture->id}}' /> <!-- Take customers to this URL when they finish their checkout  -->
