...
<div class="card"style="width:90%; margin: auto;">
  ...
  padding: 10px;" >
        ...
        <input type='hidden' name='return' value='https://gestioncapteursincendie.herokuapp.com/redirect.php?id={{$facture->id}}' /> <!-- Take customers to this URL when they finish their checkout  -->
