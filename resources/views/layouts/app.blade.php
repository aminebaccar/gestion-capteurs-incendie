...
?>
    ...
    <title>GCI - Gestion Capteurs Incendie
    </title>
    <!-- Styles -->
    ...
    <script type="text/javascript" charset="utf8" src="https://cdnjs.cloudflare.com/ajax/libs/datatables/1.10.19/js/dataTables.bootstrap4.js">
    </script>
          ...
          <div class="d-flex">
            ...
            <div class="d-flex order-lg-2 ml-auto">
              ...
              <div class="nav-item d-none d-md-flex">
                <a class="btn btn-link" href="{{ route('login') }}">@lang('Authentification')
                </a>
              </div>
              @else
...
->get();?>
                  ...
                  <a href="#" class="dropdown-item d-flex">
                    <div>
                      <strong>Capteur {{$capt['code_capteur']}}
                      </strong> a comme état: {{$historique->evenement}}
                      <div class="small text-muted">{{$historique->created_at}}
                      </div>
                    </div>
                  </a>
                  @endif
                  ...
                  <a href="/alertes" class="dropdown-item text-center text-muted-dark">Tous les alertes
                  </a>
                </div>
              </div>
              <div class="dropdown">
                <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                  ...
                  <span class="ml-2 d-none d-lg-block">
                    <span class="text-default">{{ auth()->user()->email }}
                    </span>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg order-lg-first">
              <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                ...
                <li class="nav-item">
                  <a href="/capteurs" class="nav-link">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-arrow">
                    <a href="/interventions" class="dropdown-item ">Interventions
                    </a>
                    <a href="/type_intervs" class="dropdown-item ">Types Intervention
                    </a>
                  </div>
                </li>
                @else
                <li class="nav-item dropdown">
                  <a href="/interventions/create" class="nav-link">
                    <i class="fe fe-file">
                    </i> Interventions
                  </a>
                </li>
